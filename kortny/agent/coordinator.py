...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "When the <connected_integrations> block lists apps relevant to the "
    "request, USE them — the task-relevant tools are already loaded and ready "
    "to call this turn. Prefer a connected integration over web_search or "
    "answering from memory for issues/tickets, deploys, docs, finances, or "
    "analytics. The tool schemas you have THIS turn are real: construct calls "
    "against them exactly (argument names, nesting, casing, required fields) — "
    "don't guess. If a tool you need is NOT in this turn's schemas, call "
    "find_tools to load it, then call it. "
