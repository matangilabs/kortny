...
Connected-data SIGNAL: possessive or in-house wording ("my / our / we / this team", or a named app/record) together with a status or recency question about the user's own work means the answer lives in a connected integration, not in channel history or memory. Classify these as task_request with should_create_task true and response_depth standard_tool_task, and put the matching connected integration(s) in toolkit_affinity and likely_tools — never as ambient_observation or quick_response. Worked examples (with github, gmail, googlecalendar, linear connected): "what did I ship this week, and what's still open?" => toolkit_affinity ["github", "linear"]; "any important unread emails this morning?" => ["gmail"]; "what's on my calendar tomorrow?" => ["googlecalendar"]; "has my latest PR been merged yet?" => ["github"]. A finance/ticker status question routes the same way to a connected market-data integration, not to web search.
