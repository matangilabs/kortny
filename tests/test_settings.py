...
SETTINGS_ENV_VARS = {
    ...
    "KORTNY_VERSION",
    "POSTGRES_URL",
    "KORTNY_VISION_ENABLED",
    "KORTNY_VISION_MAX_IMAGES_PER_REQUEST",
    "KORTNY_VISION_MAX_IMAGE_BYTES",
    "KORTNY_VISION_MAX_TOTAL_IMAGE_BYTES",
    "KORTNY_VISION_ALLOWED_IMAGE_MIMES",
}
